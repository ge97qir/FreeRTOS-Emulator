...
#define configSUPPORT_DYNAMIC_ALLOCATION    1      // DYNAMIC MEMORY ALLOCATION
#define configUSE_TIMERS                    1      // USING TIMERS
...
#define configMAX_SYSCALL_INTERRUPT_PRIO    RITY    1
